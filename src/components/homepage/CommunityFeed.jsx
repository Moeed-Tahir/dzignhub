    ...
    return (
        <div className="w-full max-w-[1360px]">
            <div className='flex items-center mb-4'>
                <button className="bg-[#1B1F3B] text-white flex items-center font-medium text-sm" style={{
                    width:'auto',
                    height: 32,
                    gap: "4px",
                    borderRadius: "999px",
                    ...
                    <Image src="/homepage/community-feed/global.png" alt="Community Feed" width={24} height={24} />
                    Community feed
                </button>
                <button className="ml-7 mr-3 bg-white text-[#68686B] px-4 py-1 rounded-full flex items-center gap-2 font-medium border border-1 border-[#68686B] text-sm">
