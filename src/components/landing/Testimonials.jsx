  ...
  return (
    <div className="relative w-full bg-[#1B1F3B] flex flex-col h-[767px] gap-[56px] overflow-hidden ">
      <div className="w-[1440px] pt-[80px] px-[80px]">
        <div className="w-[1280px] flex flex-col gap-[24px] text-[40px] font-semibold text-[#FAFAFA]">
      ...
      <div className=" ">
        <div className="flex gap-[16px] items-center overflow-x-auto overflow-y-hidden scrollbar-hide">
          {boxes.map((_, index) => {
