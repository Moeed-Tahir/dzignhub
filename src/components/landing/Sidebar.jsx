...
const links = [
  ...
  { href: "/image-creation", title: "Image Creation" },
  {
    ...
    subheadings: [
      ...
      { href: "/ai/ui-ux", title: "Kano · UI UX Companion" },
      { href: "/ai/seo", title: "Novi · SEO Companion" },
      { href: "/ai/strategy-assistant", title: "Mira · Strategy Assistant" },
      {
        href: "/ai/presentation-creator",
        title: "Slides · Presentation Creator",
      },
      { href: "/ai/product-visuals", title: "Fashion · Product Visuals" },
    ],
  },
...
function Sidebar({ onClose, open }) {
  ...
  return (
    <div
      ...
      className={` ${
        open ? "flex" : "hidden"
      }  md:max-w-[800px] max-w-[94%] w-full absolute md:top-[24px] md:right-[24px] right-[3%] top-[10px] bg-[#FFFFFF] rounded-[40px] md:h-[976px] h-[900px]  z-50 overflow-auto`}
    ...
    >
      <div className="relative h-full">
        ...
        <div className="absolute md:top-[60%] top-[55%] max-w-[94%] left-[3%]  w-full border-black  flex flex-col gap-[16px] md:flex-row  justify-between">
          <img src="/Logo.svg" className="max-w-[185.07px]  max-h-[35.26px]" />
