...
export default function Hero() {
  return (
    <>
      ...
      <div className=" lg:mx-auto lg:rounded-[16px] flex flex-col lg:gap-[40px] gap-[32px] lg:static absolute top-[112px]   ">
        {/* Top section (announcement + heading + paragraph) */}
        <div className="flex flex-col lg:gap-[16px] gap-[32px]">
          {/* Announcement */}
          <div className="lg:w-[492px] lg:h-[42px] w-[291px] h-[44px] flex items-center justify-around rounded-full mx-auto bg-[#212e62] ">
            ...
            <button className="lg:flex hidden w-[38px] h-[26px] rounded-full bg-[#060606] border border-[#BDFF00] items-center justify-center">
              <FaArrowRight className="text-white w-[18px] h-[18px]" />
            </button>
          </div>
          ...
          <div className="flex flex-col lg:gap-[32px] gap-[18px]">
            <h1
              className={`lg:text-[68px] text-[46px] text-white uppercase text-center leading-tight ${syne.className} font-semibold`}
            >
              Turn Your Words Into Stunning Visuals
            </h1>
            <p
              className={`lg:text-[18px] text-[20px] text-[#F0F0F3] text-center leading-[28px] lg:w-[727px] lg:h-[56px] h-[96px] w-[335px]  mx-auto ${syne.className}`}
            >
          ...
          {/* CTA Section Mobile*/}
          <div className=" w-[382px] h-[144px] flex flex-col gap-[12px] lg:hidden">
            ...
            <div className="w-full h-[60px] bg-[#BDFF00] py-[16px] px-[12px] gap-[12px] rounded-[49.11px] flex justify-center">
              <button className={` text-[20px] ${anybody.className}`}>
                <img
              ...
              <p className="text-[#1B1F3B]">Create image</p>
            </div>
          </div>
        </div>
        ...
        <div className=" hidden lg:flex lg:w-[740px] lg:h-[78px] rounded-[999px] mx-auto  items-center bg-[#212e62] justify-center gap-[10px]">
          ...
          <button
            className={`w-[179px] h-[54px] bg-[#BDFF00] text-[18px] ${anybody.className} rounded-full flex items-center justify-center gap-[8px]`}
          >
            <img
              src="/landing/starVector.svg"
              alt="star"
