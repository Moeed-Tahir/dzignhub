...
const PublishModal = ({ open, onClose }) => {
  ...
  return (
    <div className="absolute top-12 right-5 z-50000 flex items-center justify-center bg-opacity-40">
      <div className="bg-white rounded-[28px] shadow-lg w-[420px] py-8 relative flex flex-col items-center justify-center">
        <h2 className="text-xl font-semibold text-[#344054] mb-2">
          Coming Soon
        </h2>
        <p className="text-[#7b7b7b] text-[16px] font-medium text-center px-6">
          This feature will be available soon 🚀
        </p>
        <div className="flex justify-end items-center pt-6">
          <button
            onClick={onClose}
            className="bg-[#C209C1] text-white px-6 mx-6 py-2 rounded-xl font-medium transition-colors"
          >
            Close
          </button>
        </div>
  ...
  <div className="bg-white rounded-xl shadow-lg w-[420px] py-4 relative">
    <h2 className="text-xl font-medium text-[#344054] mx-6 mb-4">Publish</h2>
    <p className="text-[#7b7b7b] text-[16px] font-medium mx-6 pb-4">
      Make your project live and track it’s performance
    </p>
    <hr class="h-[1px] bg-[#ECECEC] border-0" />

    <h2 className="text-[14px] font-medium text-[#344054] mx-6 mt-3">Publish</h2>
