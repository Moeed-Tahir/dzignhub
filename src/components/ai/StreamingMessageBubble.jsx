                ...
                {toolSteps.map((step, index) => (
                  <>
                    <div key={index}>
                      ...
                      {/* ✅ EMBED INSPIRATION IMAGES AFTER "Design Inspiration Finder" TOOL (SAME AS MessageBubble) */}
                      {(step.name == "Design Inspiration Finder" || step.name == "Slide Design Inspiration Finder") && inspirationImages && inspirationImages.length > 0 && (
                        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
