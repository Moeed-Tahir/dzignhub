...
const TrashIcon = (
  <svg width="22" height="22" fill="none" viewBox="0 0 22 22"><path d="M9 10.5v4m4-4v4M4 7.5h14M6 7.5v10a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-10" stroke="#1B1F3B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M9 7.5v-2a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v2" stroke="#1B1F3B" strokeWidth="1.5" strokeLinecap="round"/></svg>
);
